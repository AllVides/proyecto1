...
namespace proyecto1.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(OContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,nombre,apellido,username,nac,contraseña,email,pais")] Usuario usuario)
        {
            ...
            {
                ModelState.AddModelError("username", "Este sueste usuario ya existe");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,nombre,apellido,username,nac,contraseña,email,pais")] Usuario usuario)
        {
